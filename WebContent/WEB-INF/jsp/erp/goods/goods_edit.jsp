					...
					<form action="goods/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td colspan="10"><input type="text" name="TITLE" id="TITLE" value="${pd.TITLE}" maxlength="255" placeholder="这里输入合同名称" title="商品名称" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">合同编号:</td>
								<td><input type="text" name="BIANMA" id="BIANMA" value="${pd.BIANMA}" maxlength="30" placeholder="这里输入合同编号" title="商品编码" style="width:98%;"/></td>
								<td style="width:75px;text-align: right;padding-top: 13px;">合同类型:</td>
								<td>
									<select class="chosen-select form-control" name="SPBRAND_ID" id="SPBRAND_ID" data-placeholder="请选择合同类型" style="vertical-align:top;width:210px;" >
										<option value="">未定义类型</option>
							...
							<tr>
								...
								<td>
									<select class="chosen-select form-control" name="SPTYPE_ID" id="SPTYPE_ID" data-placeholder="请选择客户类型" style="vertical-align:top;width:210px;" >
										<option value="">未定义类型</option>
								...
								<td>
									<select class="chosen-select form-control" name="SPUNIT_ID" id="SPUNIT_ID" data-placeholder="请选择经办人" style="vertical-align:top;width:210px;" >
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">合同内容:</td>
								<td colspan="10">
								 <script id="editor" type="text/plain" style="width:88%;height:200px;">${pd.DESCRIPTION}</script>
								</td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">合同简述:</td>
								<td colspan="10">
