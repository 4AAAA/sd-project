						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">账单名称</th>
									<th class="center">账单数量</th>
									<th class="center">预估成本</th>
									<th class="center">预估总成本</th>
									<th class="center">上报交易中心时间</th>
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									<c:if test="${QX.add == 1 }">
									<a class="btn btn-primary btn-sm" onclick="add();">结算数据上报交易中心</a>
									</c:if>
									&nbsp;&nbsp;预估售电公司总成本：<font color="red"><b>${zprice }</b></font>&nbsp;元
								</td>
