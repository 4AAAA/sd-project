				...
				<div class="row">
					...
					<form action="customer/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">洽谈名称:</td>
								<td><input type="text" name="NAME" id="NAME" value="${pd.NAME}" maxlength="100" placeholder="这里输入洽谈名称" title="姓名" style="width:98%;"/></td>
							</tr>
							...
							<tr>
								...
								<td><input type="text" name="ADDRESS" id="ADDRESS" value="${pd.ADDRESS}" maxlength="1000" placeholder="这里输入申请人" title="地址" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">所属公司:</td>
								<td><input type="text" name="AGE" id="AGE" value="${pd.AGE}" maxlength="10" placeholder="这里输入所属公司" title="年龄" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">合同电量:</td>
								<td><input type="number" name="MONEY" id="MONEY" value="${pd.MONEY}" maxlength="32" placeholder="这里输入合同电量" title="消费金额" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">洽谈方式:</td>
								<td>
							...
							<tr>
								...
								<td><input type="text" name="REMARKS2" id="REMARKS2" value="${pd.REMARKS2}" maxlength="1000" placeholder="这里输入备注" title="备注(2)" style="width:98%;"/></td>
							</tr>
							<tr>
