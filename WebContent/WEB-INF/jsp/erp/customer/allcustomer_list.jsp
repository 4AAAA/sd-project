			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="allcustomer/list.do" method="post" name="Form" id="Form">
...
<%-- 								<c:if test="${QX.toExcel == 1 }">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">洽谈编号</th>
									<th class="center">洽谈名称</th>									
									<th class="center">合同电量（万千瓦时）</th>
									<th class="center">建档时间</th>
									<th class="center">合同详情</th>
									<th class="center">客户详情</th>
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											...
											<td class='center'><a style="cursor:pointer;" onclick="chaImg('${var.CUSTOMER_ID}')">[推送合同至客户]</a></td>
											<td class='center'><a onclick="viewUser('${var.USERNAME}')" style="cursor:pointer;">[客户详情]</a></td>
											<td class="center">
	...
	<script type="text/javascript">
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>allcustomer/excel.do';
		}
	</script>
