						...
						<table style="margin-top:5px;">
							<tr>
								...
								<td style="vertical-align:top;padding-left:2px;">
								 	<select class="chosen-select form-control" name="days" id="days" data-placeholder="几天内的账单" style="vertical-align:top;width: 120px;">
									<option value=""></option>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center" onclick="orderby('xl');" style="cursor:pointer;">账单数量&uarr; &darr;</th>
									<th class="center" onclick="orderby('zj');" style="cursor:pointer;">总电费&uarr; &darr;</th>
								</tr>
							</thead>
