		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="goodsmx/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
							<input type="hidden" name="PICTURES_ID" id="PICTURES_ID" value="${pd.PICTURES_ID}"/>
							<input type="hidden" name="MASTER_ID" id="MASTER_ID" value="${pd.MASTER_ID}" maxlength="32" placeholder="这里输入属于" title="属于"/>
							<div id="zhongxin" style="padding-top: 13px;">
							<table id="table_report" class="table table-striped table-bordered table-hover">
								<tr>
									<td style="width:50px;text-align: right;padding-top: 13px;">合同名称:</td>
									<td><input type="text" name="TITLE" id="TITLE" value="${pd.TITLE}" maxlength="32" style="width:99%;" placeholder="这里输入标题" title="标题"/></td>
								</tr>
								<tr>
									<td style="width:50px;text-align: right;padding-top: 13px;">合同扫描件:</td>
									<td>
								...
								<tr>
									<td style="width:50px;text-align: right;padding-top: 13px;">序号:</td>
									<td><input type="number" name="ORDER_BY" id="ORDER_BY" value="${pd.ORDER_BY}" maxlength="32" placeholder="这里输入序号" title="序号"/></td>
								</tr>
								<tr>
...
<script type="text/javascript">
	...
	function delP(PATH,PICTURES_ID){
		 if(confirm("确定要删除图片？")){
			var url = "goodsmx/deltp.do?PATH="+PATH+"&PICTURES_ID="+PICTURES_ID+"&guid="+new Date().getTime();
